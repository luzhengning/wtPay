   ...
   public class CSm4
    {
        ...
        static void Encript(uint K0, uint K1, uint K2, uint K3, uint X0, uint X1, uint X2, uint X3, 
        ...
        static void Decript(uint K0, uint K1, uint K2, uint K3, uint X0, uint X1, uint X2, uint X3,
            out uint Y0, out uint Y1, out uint Y2, out uint Y3)
        {
            uint[] rk = new uint[32];
            int i;
        ...
        public static byte[] EncriptB(byte[] bKey, byte[] inData)
        {
            ...
            Encript(K0, K1, K2, K3, D0, D1, D2, D3, out Y0, out Y1, out Y2, out Y3);
        ...
        public static byte[] DecriptB(byte[] bKey, byte[] inData)
        {
            ...
            D2 = GET_ULONG_BE(inData, 8);
            D3 = GET_ULONG_BE(inData, 12);
            Decript(K0, K1, K2, K3, D0, D1, D2, D3, out Y0, out Y1, out Y2, out Y3);
